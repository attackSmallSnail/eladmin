...
public interface SysOrgService {
    ...
    */
    Map<String,Object> queryAll(SysOrgQueryCriteria criteria, Pageable pageable);
    ...
    */
     ...
     * @return SysOrgDto
     */
    SysOrgDto findById(String orgId);
    ...
    * @return SysOrgDto
    */
    SysOrgDto create(SysOrg resources);

    /**
    * 编辑
    * @param resources /
    */
    void update(SysOrg resources);
