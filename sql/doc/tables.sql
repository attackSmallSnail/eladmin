...
COMMENT ON COLUMN "SYS_ORG"."ORG_PROPERTY" IS '机构性质:1 中医院2妇幼保健院3综合医院4 专科医院99其他(对应sys_code 的org_property)';
...
COMMENT ON COLUMN "SYS_ORG"."ORG_CATEGORY" IS '医院类型（对应基卫机构表的JGLB00）01:卫生管理部门；02:医疗机构;03:妇幼保健院;04综合医院;05:村卫生所06:卫生服务站07:民营医院';
...
CREATE TABLE "SYS_AREA_FJZL" (
  ...
  "AREA_SHORT" VARCHAR2(50 BYTE),
   CONSTRAINT PK_SYS_AREA_FJZL PRIMARY KEY ("AREA_ID")
);
...
CREATE TABLE "DEPT" (
  ...
  "IS_DELETE" VARCHAR2(10 BYTE),
   CONSTRAINT PK_DEPT PRIMARY KEY ("DEPT_ID","ORG_ID")
);
...
CREATE TABLE "WARNING_INDICATORS" (
  ...
  "CREATE_TIME" DATE,
   CONSTRAINT PK_WARNING_INDICATORS PRIMARY KEY ("WARNING_ID")
);
...
CREATE TABLE "WARNING_INTERVAL" (
  ...
  CONSTRAINT PK_WARNING_INTERVAL PRIMARY KEY ("WARNING_ID")
);
